  ...
  const fincasWithProductores = await Promise.all([
    prisma.finca.create({
      data: {
        ...
        images: [
          "https://sevilla.abc.es/agronoma/wp-content/uploads/sites/13/2020/09/Finca-El-Cerro-1.jpg",
          "https://efeagro.com/wp-content/uploads/2016/07/foto-limones.jpg",
        ],
        productor: {
          create: {
            nombre: "Juan",
    ...
    prisma.finca.create({
      data: {
        ...
        images: [
          "https://content.cuerpomente.com/medio/2023/02/02/naranja-salvaje-un-proyecto-con-la-colaboracion-de-wwf_c3bb7f3b_1280x720.jpg",
          "https://predios.com.co/wp-content/uploads/2021/07/DJI_0208-scaled.jpg",
        ],
        productor: {
          create: {
            nombre: "Clara",
    ...
    prisma.finca.create({
      data: {
        ...
        practicesSustainable:
          "Manejo integrado de plagas y uso eficiente del agua",
        images: [
          "https://example.com/sanjuan1.jpg",
          "https://example.com/sanjuan2.jpg",
        ],
        productor: {
          create: {
            nombre: "Miguel",
    ...
    prisma.finca.create({
      data: {
        ...
        images: [
          "https://example.com/entrerios1.jpg",
          "https://example.com/entrerios2.jpg",
        ],
        productor: {
          create: {
            nombre: "Laura",
    ...
    prisma.finca.create({
      data: {
        ...
        images: [
          "https://example.com/jujuy1.jpg",
          "https://example.com/jujuy2.jpg",
        ],
        productor: {
          create: {
            nombre: "Carlos",
  ...
  const arbolesList = [
    {
      name: "Mandarino",
      images: [
        "https://cdn.shopify.com/s/files/1/0059/8835/2052/products/Nules_Clementine_2_FGT_decc1cf3-e565-48e4-b98b-e3f9df416a6f.jpg?v=1707159745",
        "https://cdn.shopify.com/s/files/1/0059/8835/2052/files/clementine.jpg?v=17071597450",
        "https://cdn.shopify.com/s/files/1/0059/8835/2052/products/Nules_Clementine_5_9a2f56e0-8f82-403d-8d2e-2db6fc509560.jpg?v=1707159745",
      ],
      price: "5000",
    },
    {
      name: "Naranjo",
      images: [
        "https://cdn.shopify.com/s/files/1/0059/8835/2052/products/Navel_Orange_1_FGT.jpg?v=1642179120",
        "https://cdn.shopify.com/s/files/1/0059/8835/2052/products/Navel_Orange_4.jpg?v=1642179120",
      ],
      price: "7000",
    },
    {
      name: "Limonero",
      images: [
        "https://media.revistaad.es/photos/60c7427b286f642f6de5ca20/master/w_1600%2Cc_limit/200724.jpg",
        "https://img.grouponcdn.com/deal/3SmThcN9ENiRbezD5G3SN4v8YETT/3S-1371x823/v1/t600x362.jpg",
      ],
      price: "6000",
    },
    {
      name: "Pomelo",
      images: [
        "https://www.rionegro.com.ar/wp-content/uploads/2023/04/thumbnail_POMELOS-PLANTA-Y-FRUTO.jpg?w=1200&h=630&crop=1",
        "https://http2.mlstatic.com/D_NQ_NP_710496-MLA43965338235_112020-O.webp",
      ],
      price: "5500",
    },
    {
      name: "Lima",
      images: [
        "https://t1.uc.ltmcdn.com/es/posts/6/9/7/como_cuidar_un_arbol_de_lima_30796_orig.jpg",
        "https://http2.mlstatic.com/D_NQ_NP_776747-MLA48056536080_102021-O.webp",
      ],
      price: "4800",
    },
  ];
